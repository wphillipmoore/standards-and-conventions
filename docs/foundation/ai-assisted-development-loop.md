...
This is a system description, not a manifesto, tutorial, or productivity guide.
...
- a bias toward architectural clarity and explicit invariants

The goal is leverage without surrendering judgment.
...
This loop reduces that serialization cost.
...
4. Decisions are externalized immediately into durable artifacts
5. Artifacts feed the next iteration

Judgment remains fully human. No output is taken on authority.
...
The AI functions as a cognitive expansion surface for human judgment.
